...
class AGVDockTest {
    ...
    void testNotEqualsLsquareBeginAGVDock() {
        AGVDock agv = new AGVDock("D1", 1, 3, 1, 3, 1, 3, "l+");
        AGVDock agv1 = new AGVDock("D1", 2, 3, 1, 3, 1, 3, "l+");
    ...
    void testNotEqualsWsquareBeginAGVDock() {
        AGVDock agv = new AGVDock("D1", 1, 3, 1, 3, 1, 3, "l+");
        AGVDock agv1 = new AGVDock("D1", 1, 5, 1, 3, 1, 3, "l+");
    ...
    void testNotEqualsLsquareDepthAGVDock() {
        AGVDock agv = new AGVDock("D1", 1, 3, 1, 4, 1, 3, "l+");
        AGVDock agv1 = new AGVDock("D1", 2, 3, 1, 3, 2, 3, "l+");
    ...
    void testNotEqualsWsquareDepthAGVDock() {
        AGVDock agv = new AGVDock("D1", 1, 3, 1, 4, 1, 3, "l+");
        AGVDock agv1 = new AGVDock("D1", 2, 3, 1, 3, 1, 6, "l+");
