...
public class FormGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "INT", "STRING", "END", 
			"QUESTION", "CHOICE", "QUEST", "SECTION", "SIGNAL", "MANDATORY", "OPTIONAL", 
			"TYPESINGLE", "TYPEFREE", "EMAIL", "NEWLINE", "SPACE", "SPACE1", "OBLIGATORINESS"
		};
	}
	...
	public FormGrammarLexer(CharStream input) {
		super(input);
