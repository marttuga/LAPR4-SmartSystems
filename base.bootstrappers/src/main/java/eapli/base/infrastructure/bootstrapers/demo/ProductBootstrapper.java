...
public class ProductBootstrapper implements Action {
    ...
    private void createProduct(String uniqueInternalCode,
                               ...
                               double width, double heigth, double length, String warehouseID, String aisle, String row, String shelf) {
        ...
        try {
            ...
            product = specifyNewProductController.specifyNewProduct(new UniqueInternalCode(uniqueInternalCode), new ShortDescription(shortDescription),
                    ...
                    new ProductPriceDetail(priceDetail), new CategoryCode(categoryCode), dimension, new WarehouseID(warehouseID),
                    new Aisle(aisle), new Row(row), new Shelf(shelf));
